    ...
    <div className="login-page">
      ...
      <div className="login-buttons">
        <Button
          ...
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }} // <-- добавлены стили
        >
          <SpotifyIcon />
        ...
        <Button
          ...
          width="max"
          disabled
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }} // <-- стили для согласованности
        >
          <AppleMusicIcon />
          Apple Music
        </Button>
